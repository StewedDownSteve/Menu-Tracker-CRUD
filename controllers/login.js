...
// this is a pretty confusing way to use async but this is what the tutorial orgnially used. Its looking in the data base to see if it can find a matching email address and if it find it, it takes the associated PW and sees if it matches the inputed PW

// Would redue this with awaits